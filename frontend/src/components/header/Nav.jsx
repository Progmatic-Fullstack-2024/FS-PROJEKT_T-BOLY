        ...
        <div className="max-w-screen-xl flex items-center justify-between mx-auto p-4">
          ...
          >
            <ul className="flex flex-col p-4 md:p-0 md:space-x-8 md:flex-row">
              <li>
                <Link to="/" className="block py-2 px-4 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700">
              ...
              <li>
                <a
                  href="#"
                  className="block py-2 px-4 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700"
                >
                  About
                </a>
              </li>
