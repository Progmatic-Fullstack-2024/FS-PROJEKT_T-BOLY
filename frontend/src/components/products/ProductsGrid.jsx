...
export default function ProductsGrid({ productsByCategory, isLoading }) {
  ...
  return (
    <div className="flex flex-wrap gap-2 2xl:gap-8 md:justify-between">
          ...
          <div className="flex flex-col" key={index}>
            <div className="relative">
              <Link to={`/products/${product.id}`}>
                ...
                <img
                  className={`border-2 rounded-2xl w-72 h-72 2xl:w-80 2xl:h-80 p-7 pr-8 shrink-0 hover:border-gray-900 dark:hover:border-white dark:bg-gray-700 dark:border-primary object-contain ${product.quantity === 0 && 'grayscale opacity-50'}`}
            ...
            <div className="flex flex-col gap-2 ml-1 mb-4">
