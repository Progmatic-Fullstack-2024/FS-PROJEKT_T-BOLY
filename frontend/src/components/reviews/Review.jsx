...
export default function Review({ review }) {
  ...
  return (
    <div className="flex items-center gap-12 p-2 border m-3 rounded-xl dark:bg-gray-800 dark:border-primary">
      <div>
        ...
        <div className="flex items-center space-x-1 rtl:space-x-reverse mb-5">
          ...
          <h3 className=" text-sm text-gray-500 dark:text-primary">{timeDiff}</h3>
        </div>
      </div>
      <div className="my-2 text-gray-500 dark:text-primary">{review.review}</div>
    </div>
  );
}
