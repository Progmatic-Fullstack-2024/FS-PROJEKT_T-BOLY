                ...
                <Form className="space-y-4">
                  <div className="flex md:h-60 md:flex-row flex-col justify-between items-center mb-4">
                    <div className="flex flex-col w-full md:w-2/3">
                      <div>
                        ...
                        <Field
                          name="name"
                          className="w-full p-2 border rounded-lg dark:bg-gray-700 dark:border-primary dark:text-primary"
                        />
                        <ErrorMessage
                          name="name"
                          component="div"
                  ...
                  <div className="flex md:flex-row sm:flex-row flex-col gap-4">
                    ...
                    <div className="flex flex-col justify-between items-center border rounded-lg p-2 md:w-1/3 dark:bg-gray-700 dark:border-primary">
                      ...
                      <div>
                        <div className="px-1">
                          <label className="text-sm font-medium dark:text-primary">
                            min Players
                          </label>
                          <Field
                        ...
                        <div className="px-1">
                          <label className="block text-sm font-medium dark:text-primary">
                            max Players
                          </label>
                          <Field
