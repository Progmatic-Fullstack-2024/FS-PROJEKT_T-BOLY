            ...
            <Form className="flex flex-row w-full">
              <div className="flex flex-col justify-between items-center mb-4 w-full">
                <div className="w-full">
                  ...
                  <Field name="firstName" className="block w-full p-2 border rounded-lg dark:bg-gray-600 dark:border-primary dark:border-2" />
                  <ErrorMessage name="firstName" component="div" className="text-red-500 text-sm" />
                </div>

                <div className="w-full">
                  <label className="block text-left text-sm font-medium">Last Name</label>
                  <Field name="lastName" className="w-full p-2 border rounded-lg dark:bg-gray-600 dark:border-primary dark:border-2" />
                  <ErrorMessage name="lastName" component="div" className="text-red-500 text-sm" />
                </div>

                <div className="w-full">
                  <label className="block text-left text-sm font-medium">Email</label>
                  <Field name="email" className="w-full p-2 border rounded-lg dark:bg-gray-600 dark:border-primary dark:border-2" />
                  <ErrorMessage name="email" component="div" className="text-red-500 text-sm" />
                </div>

                <div className="w-full">
                  <label className="block text-left text-sm font-medium">Username</label>
                  <Field name="username" className="w-full p-2 border rounded-lg dark:bg-gray-600 dark:border-primary dark:border-2" />
