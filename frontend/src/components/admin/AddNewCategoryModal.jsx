            ...
            >
              {({ setFieldValue, values }) => (
                <Form className="flex flex-col">
                  <label className="block text-left text-sm font-medium dark:text-primary">Category Name</label>
                  <Field name="name" className="block w-full p-2 border rounded-lg dark:text-primary dark:bg-gray-600 dark:border-primary dark:border-2" />
                  ...
                  <label className="block text-left text-sm font-medium mt-2 dark:text-primary">Upload Image</label>
