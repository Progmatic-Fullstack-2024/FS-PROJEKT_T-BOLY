...
export default function OrderTable() {
  ...
  return (
    <div className="border-2 rounded-xl md:p-12 p-4 h-fitdark:bg-gray-700 dark:border-primary dark:border dark:text-primary h-fit order-first md:order-none md:w-2/5">
