...
export default function Orders() {
  ...
  return (
    <div className="mx-auto w-full bg-white rounded-lg shadow-md p-8 dark:bg-gray-700 dark:border-primary dark:border">
      <h1 className="text-xl font-bold text-gray-700 mb-4 dark:text-primary">Your Orders</h1>
        ...
        <div className="fixed inset-0 bg-gray-500 bg-opacity-50 flex justify-center items-center z-[100]">
          <div className="relative bg-white p-10 rounded-lg shadow-lg w-3/5 max-h-[90vh] overflow-y-auto dark:bg-gray-800  dark:border-primary dark:border">
            ...
            <button
              ...
              className="absolute top-10 -right-20 text-2xl w-40 rounded-xl hover:text-black hover:border-gray-900 dark:hover:text-white"
            >
              <RxCross2 />
            </button>
            <div className="flex gap-10">
              <div className="flex flex-col gap-3 border-2 rounded-xl p-5 w-1/3 dark:bg-gray-700 dark:border-primary dark:border">
                ...
                <div className="font-medium dark:text-orange-600">Total Price: €{selectedOrder.totalPrice}</div>
